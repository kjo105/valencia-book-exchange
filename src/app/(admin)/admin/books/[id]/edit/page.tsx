...
import { ArrowLeft, Save, BookOpen, ImageIcon, Upload, Loader2, X } from "lucide-react";
...
export default function EditBookPage() {
      ...
      try {
        ...
        if (docSnap.exists()) {
          ...
          setFormData({
            ...
            author2Last: data.author2Last || "",
            author2First: data.author2First || "",
            genre: data.genre || "",
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (coverFile) {
        coverUrl = await uploadBookCover(id, coverFile);
      }

      const result = await updateBookAction(id, {
